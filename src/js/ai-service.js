/**
 * @fileoverview Google Gemini AI integration for the democracy dashboard.
 ...
 * @type {string}
 */
const SYSTEM_INSTRUCTION = `You are an expert Democracy Dashboard Assistant specializing in Indian democracy and electoral processes. Your role is to educate users about:
...
export function initGemini() {
  ...
  if (!apiKey || apiKey === 'your_gemini_api_key_here') {
    console.warn('[AI-Service] API key not configured. Chatbot will use fallback responses.');
    return false;
  }
  ...
  try {
    ...
    initialized = true;
    console.info('[AI-Service] AI model initialized successfully.');
    return true;
  } catch (error) {
