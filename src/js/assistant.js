/**
 * @fileoverview AI Assistant UI component.
 * Manages the assistant widget, message rendering, and user interactions.
 * @module assistant
 */

import { sendMessage, resetChat } from './ai-service.js';
